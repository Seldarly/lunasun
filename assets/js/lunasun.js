...
$(document).ready(function(){
    ...
    if(theWidth > 767) {
        ...
        // Choose one of 2 videos
        var url = (new Date()).getTime() % 2 == 0 ? 'https://player.vimeo.com/video/266940752' : 'https://player.vimeo.com/video/219352387';
        $('body')
            .prepend('<div class="vidcover"></div>');
        $('body')
            .append('<iframe class="fullvid" src="'+url+'?autoplay=1&loop=1&title=0&byline=0&portrait=0&player_id=vimeo_player" style="width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
        
        $(window).resize( function(){
            var theWidth = $(window).width(),
                theHeight = $(window).height(),
                newWidth = (theHeight*1.77777778),
                newHeight = (theWidth/1.77777778);
        ...
        // Mute video manually, automatically can be muted via "background=1" only videos from PRO accounts
        if(isSafari) {
